...
for (const file of mustEnforce) {
  const src = readFileSync(resolve(process.cwd(), `mcp-server/src/tools/${file}`), 'utf8');
...
const searchSrc = readFileSync(resolve(process.cwd(), 'mcp-server/src/tools/search-services.ts'), 'utf8');
